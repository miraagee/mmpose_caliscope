...
class PostProcessor:
    ...
    def create_xy(self):
        ...
        while self.sync_stream_manager.recorder.recording:
            ...
            logger.info(
                f"(Stage 1 of 2): {percent_complete}, {self.sync_stream_manager.recorder.sync_index}, {self.sync_stream_manager.mean_frame_count}% of frames processed for (x,y) landmark detection"
            )
